...
if __name__ == '__main__':
    ...
    model=DenseNetFCN(input_shape=(256,256,1),nb_dense_block=3,nb_layers_per_block=3,dropout_rate=0.8,reduction=0.5,initial_kernel_size=(3,3))
    ...
    model.fit_generator(datagene('train'), steps_per_epoch=558* 40, epochs=config.epochs,
